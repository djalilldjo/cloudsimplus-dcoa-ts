...
public class MissingExperimentsRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Starting Missing Experiments Generation...");
        ...
        appendCsvLine("SIMULATION_COMPLETED.txt", "MISSING SCENARIOS COMPLETED SUCCESSFULLY AT: " + new java.util.Date());
    }
    ...
    private static RunMetrics executeSimulation(RunConfig config, boolean withDeadlines, double phi, double rho) {
        ...
        EnergyEstimator estimator = MissingExperimentsRunner::estimateEnergyPreSim;
